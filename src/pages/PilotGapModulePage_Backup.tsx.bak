...
import { WhatLowTimerPilotPage } from './components/WhatLowTimerPilotPage';
import { WhatPilotGapPage } from './components/WhatPilotGapPage';
import { WhatPilotShortagePage } from './components/WhatPilotShortagePage';
...
const PilotGapModulePage: React.FC<PilotGapModulePageProps> = ({ onBack, onComplete, onNavigateToMentorModules }) => {
    ...
    const navigationFlow = [
        ...
        // Module 2 chapters
        { chapter: 99, topic: 'mentor-differentiation' },
        { chapter: 99, topic: 'ebt-cbta-competencies' },
        { chapter: 99, topic: 'prescription-methodology' },
        { chapter: 99, topic: 'problem-solving-framework' },
        { chapter: 99, topic: 'assessment-techniques' },
        { chapter: 99, topic: 'consultation-support' },
        { chapter: 99, topic: 'behavioral-change' }
    ];
    ...
    const renderChapterContent = () => {
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', animation: 'fadeIn 0.5s ease-in-out' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '4.5rem', alignItems: 'center' }}>
                            ...
                            <section style={{ textAlign: 'center', maxWidth: '42rem', marginTop: '2rem' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                                    <p style={{ color: '#475569', fontSize: '1.05rem', lineHeight: 1.7, margin: 0 }}>
                                        Welcome to the WingMentor Foundational Program. This module is your first step toward true industry recognition. Broken down into four core segments, it is meticulously designed to bridge the gap between your initial commercial license and the rigorous expectations of the airline flight deck.
                                    </p>
                                    <p style={{ color: '#475569', fontSize: '1.05rem', lineHeight: 1.7, margin: 0 }}>
                                        The concepts within these segments form the basis of your Pre-Foundation Knowledge Exam. This assessment evaluates a dynamic combination of our proprietary program architecture and the regulatory standards of governing bodies such as the FAA, CAAP, and EASA. Furthermore, your evaluation will be strictly calibrated to your current technical proficiency and the specific skill levels you are assigned to mentor.
                                    </p>
                                </div>
                            </section>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', textAlign: 'left' }}>
                                    <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start', cursor: 'pointer' }} onClick={() => setCurrentChapter(1)}>
                                        ...
                                        <div>
                                            ...
                                            <p style={{ color: '#475569', fontSize: '16px', lineHeight: 1.625, margin: 0 }}>Understand the true landscape of commercial aviation: who the gatekeepers are, what they actually evaluate, and why the gap between CPL graduation and airline employment exists.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start', cursor: 'pointer' }} onClick={() => setCurrentChapter(1)}>
                                        ...
                                        <div>
                                            ...
                                            <p style={{ color: '#475569', fontSize: '16px', lineHeight: 1.625, margin: 0 }}>Discover the reality of the "Experience Void." Learn the true nature of the Pilot Shortage, the hidden professional costs of the Pilot Gap, and exactly what Pilot Recognition demands from you.</p>
                                        </div>
                                    </div>
                                    <div style={{ height: '1px', backgroundColor: 'rgba(226, 232, 240, 0.8)', marginLeft: '3.5rem' }}></div>
                                    <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start', cursor: 'pointer' }} onClick={() => setCurrentChapter(2)}>
                                        ...
                                        <div>
                                            ...
                                            <p style={{ color: '#475569', fontSize: '16px', lineHeight: 1.625, margin: 0 }}>Understand how WingMentor bridges the industry gap through Pilot Recognition, the ATLAS CV, and an intelligent pathway that transforms low-timer risk into verifiable, high-competency value.</p>
                                        </div>
                                    </div>
                                    <div style={{ height: '1px', backgroundColor: 'rgba(226, 232, 240, 0.8)', marginLeft: '3.5rem' }}></div>
                                    <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start', cursor: 'pointer' }} onClick={() => { setCurrentChapter(2); setCurrentTopic('initial-exam-access'); }}>
                                        ...
                                        <div>
                                            ...
                                            <p style={{ color: '#475569', fontSize: '16px', lineHeight: 1.625, margin: 0 }}>Access the official WingMentor Foundation Program examination. Calibrated to your specific license rating and administered directly through this portal, it serves as your first formal milestone and data point in the program.</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', animation: 'fadeIn 0.5s ease-in-out' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '4.5rem', alignItems: 'center' }}>
                            ...
                            <section style={{ textAlign: 'center', maxWidth: '42rem', marginTop: '2rem' }}>
                                ...
                                <p style={{ color: '#475569', fontSize: '1.05rem', lineHeight: 1.7, margin: 0 }}>
                                    You have passed your checkride. Whether you spent four rigorous years earning an aviation degree or sprinted through an intensive fast-track academy, the celebrations are over. But what does life after graduation actually look like? When you emerge with a freshly printed commercial license, you are stepping out of a highly controlled simulator bubble and directly into the unforgiving reality of the commercial aviation industry.
                                </p>
                            </section>
                            ...
                            <section style={{ textAlign: 'center', maxWidth: '42rem' }}>
                                ...
                                <p style={{ color: '#475569', fontSize: '1.05rem', lineHeight: 1.7, margin: 0 }}>
                                    The media aggressively advertises a global "pilot shortage," leading graduates to believe airlines are waiting with open doors the moment they finish training. As your industry insiders, we need to reset your expectations: the reality is vastly different. The industry is indeed desperate for crew, but operators are extremely hesitant to hand the flight controls of a multi-million-dollar asset to a pilot with only 250 hours of highly scripted experience.
                                </p>
                            </section>
                            ...
                            <section style={{ textAlign: 'center', maxWidth: '42rem' }}>
                                ...
                                <p style={{ color: '#475569', fontSize: '1.05rem', lineHeight: 1.7, margin: 0 }}>
                                    Regardless of how you earned your wings, the industry currently views you through a single, uncompromising lens: you are a "Low-Timer." You have entered the "Experience Void"—the massive, unspoken chasm between holding a legal 250-hour Commercial Pilot License (CPL) and possessing the advanced, multi-crew operational maturity that airlines actually demand.
                                </p>
                                <p style={{ color: '#475569', fontSize: '1.05rem', lineHeight: 1.7, margin: 0 }}>
                                    In this chapter, we define the three core realities of your current operational status before we show you how to solve them:
                                </p>
                            </section>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', textAlign: 'left' }}>
                                    <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start', cursor: 'pointer' }} onClick={() => { setCurrentTopic('what-low-timer'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}>
                                        ...
                                        <div>
                                            ...
                                            <p style={{ color: '#475569', fontSize: '16px', lineHeight: 1.625, margin: 0 }}>Understand why your hard-earned license is currently viewed by operators—and their insurers—as an operational liability rather than a deployable asset.</p>
                                        </div>
                                    </div>
                                    <div style={{ height: '1px', backgroundColor: 'rgba(226, 232, 240, 0.8)', marginLeft: '3.5rem' }}></div>
                                    <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start', cursor: 'pointer' }} onClick={() => { setCurrentTopic('what-pilot-gap'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}>
                                        ...
                                        <div>
                                            ...
                                            <p style={{ color: '#475569', fontSize: '16px', lineHeight: 1.625, margin: 0 }}>Deconstruct the brutal developmental chasm between your 250 hours of rote flight training and the dynamic, high-stakes environment of the airline flight deck.</p>
                                        </div>
                                    </div>
                                    <div style={{ height: '1px', backgroundColor: 'rgba(226, 232, 240, 0.8)', marginLeft: '3.5rem' }}></div>
                                    <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start', cursor: 'pointer' }} onClick={() => { setCurrentTopic('what-pilot-shortage'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}>
                                        <div style={{ width: '2rem', height: '2rem', borderRadius: '50%', backgroundColor: '#0284c7', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', flexShrink: 0, marginTop: '0.125rem', fontSize: '0.875rem' }}>3</div>
                                        <div>
                                            <h4 style={{ color: '#2563eb', fontWeight: 700, fontSize: '0.875rem', textTransform: 'uppercase', letterSpacing: '0.15em', marginBottom: '0.5rem' }}>The Illusion: The Shortage Paradox</h4>
                                            <p style={{ color: '#475569', fontSize: '16px', lineHeight: 1.625, margin: 0 }}>Discover why the industry is simultaneously starving for qualified crew, yet still fundamentally refusing to hire entry-level graduates.</p>
                                        </div>
                                    </div>
                                </div>
        ...
        // ── Module 2: Mentor Training Chapters ─────────────────────────--
        if (currentTopic === 'mentor-differentiation') {
            return <MentorModulesPage1 onBack={onBack} />;
        }
        if (currentTopic === 'ebt-cbta-competencies') {
            return <MentorModulesPage2 onBack={onBack} />;
        }
        if (currentTopic === 'prescription-methodology') {
            return <MentorModulesPage3 onBack={onBack} />;
        }
        if (currentTopic === 'problem-solving-framework') {
            return <MentorModulesPage4 onBack={onBack} />;
        }
        if (currentTopic === 'assessment-techniques') {
            return <MentorModulesPage5 onBack={onBack} />;
        }
        if (currentTopic === 'consultation-support') {
            return <MentorModulesPage6 onBack={onBack} />;
        }
        if (currentTopic === 'behavioral-change') {
                ...
                <aside style={{ width: '320px', flexShrink: 0, backgroundColor: 'white', borderRight: '1px solid #e2e8f0', padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1.5rem', position: 'sticky', top: '104px', height: 'calc(100vh - 104px)', overflowY: 'auto' }}>
                    ...
                    <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
                        {([
                            ...
                            {
                                title: 'Solutions - Mentor Training', id: 99,
                                topics: [
                                    { label: 'Chapter 1: Mentor vs Flight Instructor Differentiation', slug: 'mentor-differentiation' },
                                    { label: 'Chapter 2: EBT CBTA Core Competencies Deep Dive', slug: 'ebt-cbta-competencies' },
                                    { label: 'Chapter 3: Prescription Methodology', slug: 'prescription-methodology' },
                                    { label: 'Chapter 4: Problem-Solving Framework', slug: 'problem-solving-framework' },
                                    { label: 'Chapter 5: Assessment & Evaluation Techniques', slug: 'assessment-techniques' },
                                    { label: 'Chapter 6: Consultation & Support Skills', slug: 'consultation-support' },
                                    { label: 'Chapter 7: Behavioral Change Facilitation', slug: 'behavioral-change' },
                                ]
                            },
                                                ...
                                                {item.topics!.map(topic => {
                                                    ...
                                                    return (
                                                        <li key={topic.slug}>
                                                            <button
                                                                onClick={() => { 
                                                                    // Set the topic for Module 2 chapters
